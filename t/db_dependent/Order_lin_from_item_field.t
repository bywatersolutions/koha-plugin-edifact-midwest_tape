...
use Koha::Database;
use Koha::Items;
use Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestTape;
use Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestTape::Edifact::Order;
...
sub _new_plugin {
    my (%settings) = @_;
    my $plugin = Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestTape->new(
...
sub _build_edifact_order {
    ...
    return Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestTape::Edifact::Order
        ->new(
        {
