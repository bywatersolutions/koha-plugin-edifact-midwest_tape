...
use Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestTape::Edifact;
...
my $edi = Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestTape::Edifact->new(
    { transmission => $invoic } );
my ($msg) = @{ $edi->message_array };
isa_ok( $msg,
    'Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestTape::Edifact::Message',
...
subtest 'shipment_charge sums per plugin shipment_charges_moa_* settings' => sub {
    ...
    my $stub_plugin = sub {
        ...
        bless { _settings => \%settings },
            'Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestTape::TestStub';
    };

    {
        no strict 'refs';
        *{'Koha::Plugin::Com::ByWaterSolutions::EdifactMidwestTape::TestStub::retrieve_data'}
